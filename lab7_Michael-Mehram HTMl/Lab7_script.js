...
colorButtons.addEventListener("click", function (event_listener) {
  if (event_listener.target.classList.contains("color-btn")) {
      const selectedColor = event_listener.target.style.backgroundColor;
